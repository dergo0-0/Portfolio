...
const translations = {
  uk: {
    ...
    certificates: {
      ...
      open: 'відкрити PDF',
      wheel: ['Applied AI', 'Agents', 'AI Found.', 'Deineha'],
      list: [
        {
          id: '01',
        ...
        },
        {
          id: '04',
          name: 'Serhii Deineha',
          desc: 'Персональний сертифікат. Деталі можна оновити в i18n.jsx.',
          issuer: '—',
          year: '2026',
          tech: ['—'],
    ...
    certificates: {
      ...
      list: [
        ...
        },
        {
          id: '04',
          name: 'Serhii Deineha',
          desc: 'Personal certificate. Details can be updated in i18n.jsx.',
          issuer: '—',
          year: '2026',
          tech: ['—'],
          fileName: 'serhii-deineha.pdf',
