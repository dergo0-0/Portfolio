...
const translations = {
  uk: {
    ...
    certificates: {
      ...
      open: 'відкрити PDF',
      wheel: ['Applied AI', 'Agents', 'AI Found.', 'TECH CAMP'],
      list: [
        {
          id: '01',
          name: 'Applied AI Foundations',
          desc: 'Курс з основ застосування штучного інтелекту: промпти, генерація, робочі AI-пайплайни.',
          issuer: 'AI Course',
          logo: 'AAI',
          year: '2026',
          tech: ['AI', 'Prompts', 'Workflow'],
          fileName: 'applied-ai-foundations.pdf',
        },
        {
          id: '02',
          name: 'Agents and Workflows',
          desc: 'Проєктування AI-агентів та автоматизація робочих процесів з використанням агентних систем.',
          issuer: 'AI Course',
          logo: 'AG',
          year: '2026',
          tech: ['Agents', 'Automation', 'LLM'],
          fileName: 'agents-and-workflows.pdf',
        },
        {
          id: '03',
          name: 'AI Foundations',
          desc: 'Базові принципи штучного інтелекту: моделі, тренування, обмеження та практичні кейси.',
          issuer: 'AI Course',
          logo: 'AI',
          year: '2026',
          tech: ['AI', 'ML Basics', 'LLM'],
          fileName: 'ai-foundations.pdf',
        },
        {
          id: '04',
          name: 'TECH CAMP МАН',
          desc: 'Участь у Tech camp Малої академії наук України: практичні воркшопи, командна робота, захист проєкту.',
          issuer: 'МАН України',
          logo: 'МАН',
          year: '2026',
          tech: ['Workshop', 'Teamwork', 'Project'],
          fileName: 'serhii-deineha.pdf',
        },
      ],
    },
    projects: {
    ...
    contact: {
      ...
      links: [
        ...
        { label: 'Команда', value: 'dijitalhq@gmail.com', href: 'mailto:dijitalhq@gmail.com' },
      ],
  ...
  en: {
      ...
      list: [
        {
          id: '01',
          name: 'Applied AI Foundations',
          desc: 'Course on the basics of applying artificial intelligence: prompts, generation, working AI pipelines.',
          issuer: 'AI Course',
          logo: 'AAI',
          year: '2026',
          tech: ['AI', 'Prompts', 'Workflow'],
        ...
        },
        {
          id: '02',
          name: 'Agents and Workflows',
          desc: 'Designing AI agents and automating workflows using agentic systems.',
          issuer: 'AI Course',
          logo: 'AG',
          year: '2026',
          tech: ['Agents', 'Automation', 'LLM'],
        ...
        },
        {
          id: '03',
          name: 'AI Foundations',
          desc: 'Core AI principles: models, training, limitations and practical use cases.',
          issuer: 'AI Course',
          logo: 'AI',
          year: '2026',
          tech: ['AI', 'ML Basics', 'LLM'],
        ...
        },
        {
          id: '04',
          name: 'TECH CAMP МАН',
          desc: 'Participation in the Tech camp of the Junior Academy of Sciences of Ukraine: hands-on workshops, teamwork, project defense.',
          issuer: 'JAS of Ukraine',
          logo: 'МАН',
          year: '2026',
          tech: ['Workshop', 'Teamwork', 'Project'],
          fileName: 'serhii-deineha.pdf',
    ...
    contact: {
      ...
      links: [
        ...
        { label: 'GitHub', value: 'Dergo0-0', href: 'https://github.com/Dergo0-0' },
        { label: 'Email', value: 'wallmartbag1991@gmail.com', href: 'mailto:wallmartbag1991@gmail.com' },
        { label: 'Team', value: 'dijitalhq@gmail.com', href: 'mailto:dijitalhq@gmail.com' },
      ],
